            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="main-breadcrumb pt-3 text-left text-md-right">
                        <a href="">Home</a> / <a href="">People</a> / <a href="">Statistics</a> / <span>Overview</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            <div class="content-panel col-md-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="people-stats.php">People</a>
                    </li>
                </ul>
                                    ...
                                    <div class="content-area">
                                        <div class="row no-gutters">
                                            <div class="col-md-8 col-xl-9">
                                                <div class="">
                                                    <strong>Trends</strong> - 48 Supporters added last week
                                                </div>
                                            </div>
                        ...
                        <div class="table-wrap">
                            ...
                            <table class="table table-hover table-striped table-custom">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Linkedin Page</th>
                                    <th scope="col">Twitter</th>
                                    <th scope="col">FB Page</th>
...
<script>
    ...
    Highcharts.chart('line-chart', {
        ...
        series: [{
            name: 'Total Users',
            data: [57177, 43934, 52503, 69658, 97031, 137133, 154175, 119931]
        }, {
            name: 'Supporters',
            data: [29742, 24916, 24064, 29851, 32490, 38121, 40434, 30282]
        }, {
            name: 'Prospects',
