                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="form-feild-info">Maximum width: 200px, Maximum height: 200px, Maximum size: 500kb</div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="from-date" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" data-target="#from-date" placeholder="1990-01-01 03:00"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="to-date" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" data-target="#to-date" placeholder="1990-01-01 03:00"/>
