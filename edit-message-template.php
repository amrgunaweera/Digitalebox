            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="main-breadcrumb pt-3 text-left text-md-right">
                        <a href="">Home</a> / <a href="">Communication</a> / <a href="">Message Templates</a> / <span>Update Template</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="content-area">
                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Name</label>
                                    <input type="text" class="form-control" id="" placeholder="Name" value="Test Template">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Description</label>
                                    <textarea class="form-control" placeholder="Description">Test Description</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Email Subject</label>
                                    <input type="text" class="form-control" id="" placeholder="Name" value="Test Email">
                                </div>
