            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="main-breadcrumb pt-3 text-left text-md-right">
                        <a href="">Home</a> / <a href="">System</a> / <a href="">Portal Settings</a> / <a href="">Images</a> / <span>Edit</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="content-area">
                            ...
                            <div class="form-row text-left">
                                <div class="form-group col-md-12">
                                    <button type="button" data-toggle="modal" data-target="#addNew" class="btn btn-primary" >Add New Image</button>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            if (URL) {
                ...
                $EditInputImage.prop('disabled', true).parent().addClass('disabled');
            }
